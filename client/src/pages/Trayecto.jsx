...
export default function PaginaTrayecto() {
    ...
    useEffect(() => {
        const fetchUnidades = async () => {
            try {
                const response = await axios.get(`/Trayecto/Unidades-Curriculares?Trayecto=${Trayecto}`);
            ...
            <Box sx={{ mt: 18, px: 4, pb: 10 }}>
                ...
                {loading ? (
                    ...
                    <Grid container spacing={2} justifyContent="center" sx={{ mb: 6 }}>
                        {secciones.map((seccion) => (
                            <Grid item xs={12} sm={6} md={4} key={seccion.id} display="flex" justifyContent="center">
                ...
                {loading ? (
                    ...
                    <Grid container spacing={2} justifyContent="center">
                        {unidades.map((uc) => (
                            <Grid item xs={12} sm={6} md={4} key={uc.id_unidad_curricular} display="flex" justifyContent="center">
