import { Card, CardContent, Box, Typography, Divider, Avatar, Chip } from "@mui/material";
import CustomButton from "./customButton";
import CustomChip from "./CustomChip";

export default function CardAdmin({ usuario }) {
  console.log(usuario);
  ...
  const getButtonAction = (roles) => {
    // Si tiene roles administrativos (excluyendo profesor), mostrar "Revocar"
    const hasAdminRoles = roles?.some(rol => 
      rol.id_rol !== 1 && rol.nombre_rol !== "Profesor"
    );
    return hasAdminRoles ? "Revocar" : "Asignar";
  };
  ...
  const getButtonColor = (roles) => {
    ...
    return hasAdminRoles ? "error" : "primary";
  };
