...
export async function up(knex){
  await knex.schema.createTable('trayectos', (table) => {
    table.increments('id_trayecto').primary().notNullable().comment('ID único del trayecto');
    ...
    // Soft delete
    table.boolean('activo').notNullable().defaultTo(true).comment('Estado activo/inactivo del trayecto');
