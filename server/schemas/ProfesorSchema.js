...
const ProfesorSchema = z.object({
  ...
  area_de_conocimiento: z.array(
    z.number({ 
      invalid_type_error: 'El área de conocimiento debe ser un número' 
    }).positive("Debe ser un número positivo")
  ).nonempty("Debe tener al menos un área de conocimiento"),

  pre_grado: z.array(preGradoSchema)
